...
rh = window.rh;
model = rh.model;
var defaultTopic = "os8_cli/first_topic.htm";
rh._.exports(defaultTopic);
rh.consts('DEFAULT_TOPIC', encodeURI("os8_cli/first_topic.htm"));
rh.consts('HOME_FILEPATH', encodeURI('index.htm'));
rh.consts('START_FILEPATH', encodeURI('index.htm'));
rh.consts('HELP_ID', '048870d1-6c04-4da8-895a-29f29a685e30' || 'preview');
...
model.publish(rh.consts('KEY_HEADER_TITLE'), "OmniSwitch AOS Online Help");
model.publish(rh.consts('PDF_FILE_NAME'), "");
model.publish(rh.consts('MAX_SEARCH_RESULTS'), "20");
model.publish(rh.consts('KEY_SKIN_FOLDER_NAME'), "ale_oceanic");
