...
(function () {
	...
	model.publish(rh.consts('KEY_SEARCH_HIGHLIGHT_COLOR'), "#F5F5F5")
	model.publish(rh.consts('KEY_SEARCH_BG_COLOR'), "#ffff00")
	model.publish(rh.consts('DATA_TOC_IMG_DATA_SET'),["template/ale_oceanic/tocimg1.png","template/ale_oceanic/tocimg2.png"]);
	...
	model.publish(rh.consts('MINITOC_TO_LEVEL'), 1)
